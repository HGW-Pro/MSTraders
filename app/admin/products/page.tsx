...
export default function AdminProductsPage() {
  ...
  const handleOpenEdit = (product: Product) => {
    ...
    setFormData({
      ...
      images: product.images && product.images.length > 0 ? product.images : ['https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&w=800&q=80'],
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      const payload: Partial<Product> = {
        ...
        images: formData.images.length > 0 ? formData.images : ['https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&w=800&q=80'],
