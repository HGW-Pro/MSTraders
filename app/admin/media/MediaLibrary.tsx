// Media Library - currently disabled.
// This component is intact but not routed: app/admin/media/page.tsx
// redirects to the dashboard and the nav entry in app/admin/layout.tsx
// is commented out. To re-enable, make this the default export of
// page.tsx again and uncomment the nav entry.
'use client';
