...
const jalsaBag = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" width="100%" height="100%">
  ...
  <g filter="url(#softShadow)">
    ...
    <text x="430" y="325" font-family="sans-serif" font-size="12" font-weight="bold" fill="#96172e" text-anchor="middle" letter-spacing="3">CLOTHING COMPANY</text>

    <text x="430" y="405" font-family="'Playfair Display', Georgia, serif" font-size="52" font-style="italic" font-weight="900" fill="#96172e" text-anchor="middle" letter-spacing="1">JALSA</text>

    <text x="430" y="445" font-family="sans-serif" font-size="11" font-weight="bold" fill="#96172e" text-anchor="middle" letter-spacing="3">CLOTHING COMPANY</text>
...
const fusionFashionBag = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" width="100%" height="100%">
  ...
  <g filter="url(#shadowD)">
    ...
    <text x="400" y="535" font-family="'Brush Script MT', 'Great Vibes', cursive" font-size="44" font-weight="bold" fill="#b02652" text-anchor="middle">Fusion Fashion</text>
...
const bakeryFoodBags = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" width="100%" height="100%">
  ...
  <g filter="url(#fsh)">
    ...
    <g>
      ...
      <text x="335" y="340" font-family="sans-serif" font-size="10" font-weight="bold" fill="#dc2626" text-anchor="middle">BAKERY &amp; SNACKS</text>
...
const burgerWrapPaper = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" width="100%" height="100%">
  ...
  <g fill="#dc2626">
    <g transform="translate(150, 150)">
      <circle cx="0" cy="0" r="50" fill="none" stroke="#dc2626" stroke-width="3"/>
      <text x="0" y="-15" font-family="sans-serif" font-size="10" font-weight="900" text-anchor="middle">AWARDED AS</text>
      <text x="0" y="8" font-family="sans-serif" font-size="20" font-weight="900" text-anchor="middle">BEST</text>
      <text x="0" y="28" font-family="sans-serif" font-size="12" font-weight="bold" text-anchor="middle">IN BURGER</text>
    </g>
    ...
    <text x="400" y="320" font-family="sans-serif" font-size="44" font-weight="900" text-anchor="middle" letter-spacing="4">BURGER</text>
    <text x="400" y="380" font-family="sans-serif" font-size="28" font-weight="900" text-anchor="middle" letter-spacing="2">AWARDED AS BEST</text>
    ...
    <text x="400" y="660" font-family="sans-serif" font-size="44" font-weight="900" text-anchor="middle" letter-spacing="4">BURGER</text>
    <text x="400" y="720" font-family="sans-serif" font-size="28" font-weight="900" text-anchor="middle" letter-spacing="2">AWARDED AS BEST</text>
  </g>
</svg>`;
...
// Industries
writeSvg('./public/images/industries/hospitality.svg', rajputiLuxuryBag);
writeSvg('./public/images/industries/restaurants.svg', bakeryFoodBags);
writeSvg('./public/images/industries/fashion.svg', jalsaBag);
writeSvg('./public/images/industries/retail.svg', rainbowLoopBags);
writeSvg('./public/images/industries/medical.svg', kraftGroceryPouches);
writeSvg('./public/images/industries/corporate.svg', rajputiLuxuryBag);
writeSvg('./public/images/industries/events.svg', fusionFashionBag);

console.log('ALL REAL ASSETS GENERATED PERFECTLY!');
